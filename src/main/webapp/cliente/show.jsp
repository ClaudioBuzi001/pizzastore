			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9">${cliente_visualizza_att.id}</dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Nome:</dt>
							  <dd class="col-sm-9">${cliente_visualizza_att.nome}</dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Cognome:</dt>
							  <dd class="col-sm-9">${cliente_visualizza_att.cognome}</dd>
					    	</dl>

					    	<dl class="row">
							  <dt class="col-sm-3 text-right">indirizzo:</dt>
							  <dd class="col-sm-9">${cliente_visualizza_att.indirizzo}</dd>
					    	</dl>
